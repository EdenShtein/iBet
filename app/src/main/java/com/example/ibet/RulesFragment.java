...
public class RulesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        textView3.setText(
                ...
                "\n" +
                "- Match result - \n" +
                "predict the correct winner or loser in the end of the match: +3 points \n" +
                "\n" +
                "- Half time result - \n" +
                "predict the correct winner or loser in the end of the second half: +1 points\n" +
                "\n" +
                "- Over/under score - \n" +
                "predict whether the total score is going to be over or under a certain given number: +2 points" + "\n");
        ...
        textView4.setText(
                ...
                "\n" +
                "For example: \n" +
                "Player X bet on Team A vs Team B: \n" +
                "1. Match result - Team A wins \n" +
                "2. Half time result - Team A wins \n" +
                "3. Over/under score - under 150 \n" +
                "\n" +
        ...
        textView6.setText(
                "A key aspect of the game is the opportunity to compete against friends, colleagues and players from around the globe in private groups. \n" +
                ...
                "A private group lasts for the entire tournament. \n" +
                "you can invite anyone to your group by sharing the unique code or link either via email or on social media. \n");

        textView7.setText("Changing the scoring system\n");

        textView8.setText(
                "As said above, the points awarded for: match result, half time result, over/under score.\n" +
        ...
        textView11.setText(
                ...
                "feel free to email ibet@cs.ibet.com and we will get back to you as soon as we can.");
